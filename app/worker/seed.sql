...
INSERT INTO companies (id, company, contact, phone, email, license, ubi, city, state, zip, crews, coverage, insurance, bond, contract) VALUES
  ('c1', 'Cascade Roofworks', 'Miguel Alvarez', '206-555-0101', 'miguel@cascaderoof.com', 'CASCARW123AB', '601234567', 'Seattle', 'WA', '98101',
   ...
   '{"key":"seed/insurance.pdf","name":"COI.pdf"}', '{"key":"seed/bond.pdf","name":"Bond.pdf"}', '{"key":"seed/contract.pdf","name":"Agreement.pdf"}'),
  ('c2', 'Emerald Exteriors', 'Dana Cho', '206-555-0102', 'dana@emeraldext.com', 'EMERAEX456CD', '601234568', 'Tacoma', 'WA', '98402',
   ...
   '{"mode":"cities","cities":["Tacoma","Auburn"]}', NULL, NULL, NULL);
