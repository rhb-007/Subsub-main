...
INSERT INTO companies (id, company, contact, phone, email, license, ubi, city, state, zip, crews, coverage, insurance, bond, contract, w9, doc_files) VALUES
  ('c1', 'Cascade Roofworks', 'Miguel Alvarez', '206-555-0101', 'miguel@cascaderoof.com', 'CASCARW123AB', '601234567', 'Seattle', 'WA', '98101',
   ...
   1, 1, 1, 1, '{"insurance":"cascade-insurance.pdf","bond":"cascade-bond.pdf","contract":"cascade-agreement.pdf","w9":"cascade-w9.pdf"}'),
  ('c2', 'Emerald Exteriors', 'Dana Cho', '206-555-0102', 'dana@emeraldext.com', 'EMERAEX456CD', '601234568', 'Tacoma', 'WA', '98402',
   ...
   '{"mode":"cities","cities":["Tacoma","Auburn"]}', 0, 0, 0, 0, '{}');
